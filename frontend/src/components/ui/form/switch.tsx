  ...
  return (
    <div className={"relative w-11 h-6"}>
      <input
        ...
        className={`peer appearance-none shrink-0 w-11 h-6 rounded-full bg-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition checked:bg-green disabled:bg-gray-300 cursor-pointer ${className}`}
        {...props}
      />
